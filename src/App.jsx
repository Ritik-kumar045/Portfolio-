...
const Portfolio = () => {
  ...
  const skills = [
    ...
    { name: "Next.js", level: 60, icon: <Code className="w-6 h-6" /> },
    { name: "CSS/Tailwind", level: 82, icon: <Palette className="w-6 h-6" /> },
    { name: "HTML", level: 85, icon: <Code className="w-6 h-6" /> },
    { name: "MongoDB", level: 60, icon: <Code className="w-6 h-6" /> },
    { name: "Node.js", level: 70, icon: <Code className="w-6 h-6" /> },
    { name: "Express", level: 60, icon: <Code className="w-6 h-6" /> },
    { name: "SQL", level: 70, icon: <Code className="w-6 h-6" /> },
    { name: "Python", level: 60, icon: <Code className="w-6 h-6" /> },
    { name: "MS Excel", level: 70, icon: <Code className="w-6 h-6" /> },
  ];

  const projects = [
    {
      title: "AI-Assistance Chat Web-App",
      description:
        "A full-stack real-time AI chat application with intelligent response generation....",
      tech: ["TypeScript", "React", "Node.js", "Express", "Gemini API"],
      image: "\Screenshot 2025-11-23 142046.png",
      github: "https://github.com/Ritik-kumar045/ai-chat-frontend",
      live: "https://ai-chat-frontend-red.vercel.app/",
      featured: true,
    },
    {
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1496950866446-3253e1470e8e?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MzB8fHRyYXZlbHxlbnwwfHwwfHx8MA%3D%3D",
  ...
  const handleContactSubmit = () => {
    alert(
      "Thanks for your interest! Please reach out via email or social media.",
    );
  };
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="z-10 text-center max-w-4xl mx-auto px-4">
          ...
          <p className="text-lg text-gray-400 dark:text-gray-600 mb-12 max-w-3xl mx-auto">
            ...
            functionality. Passionate about building scalable applications and
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <p className="text-lg text-gray-300 dark:text-gray-700 leading-relaxed">
                Hi, I’m Ritik Kumar — a passionate frontend developer with a
                strong foundation in JavaScript, React.js, and responsive UI
                design. I enjoy transforming ideas into elegant, efficient web
                interfaces. I focus on crafting intuitive and visually appealing
                user experiences.
              </p>
              <p className="text-lg text-gray-300 dark:text-gray-700 leading-relaxed">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {skills.map((skill) => (
              <div
                key={skill.name}
                className="bg-slate-800/50 dark:bg-gray-200 p-6 rounded-xl backdrop-blur-sm border border-purple-500/20 hover:border-purple-500/40 transition-all duration-300 transform hover:scale-105"
              >
      ...
      <section
        id="projects"
        className="py-20 bg-slate-800/50 dark:bg-gray-200 transition-colors duration-300"
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-4xl font-bold text-center mb-16 bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">
            Featured Projects
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {projects.map((project, idx) => (
              <div
                key={idx}
                className={`bg-slate-800/50 dark:bg-gray-200 rounded-xl overflow-hidden backdrop-blur-sm border transition-all duration-300 transform hover:scale-105 group ${
                  project.featured
                ...
                <div className="p-6">
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    {project.tech.map((tech, i) => (
                      <span
                        key={i}
                        className="bg-purple-900/30 text-purple-300 dark:text-purple-700 px-3 py-1 rounded-full text-sm"
                      >
                        {tech}
                      </span>
                    ))}
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div className="space-y-8">
              ...
              <div className="space-y-6">
                <a
                  href="mailto:ritikkumarsingh647@gmail.com"
                  className="flex items-center gap-4 text-purple-400 hover:text-purple-300"
                >
                  <Mail className="w-6 h-6" />
                  <div>
                    <p className="font-semibold dark:text-black">Email</p>
                    <p className="text-gray-400 dark:text-gray-600">
                      ritikkumarsingh647@gmail.com
                    </p>
                  </div>
                </a>
                <a
                  href="https://www.linkedin.com/in/ritik-kumar-9682b1231/"
                  className="flex items-center gap-4 text-purple-400 hover:text-purple-300"
                >
                  <Linkedin className="w-6 h-6" />
                  <div>
                    <p className="font-semibold dark:text-black">LinkedIn</p>
                    <p className="text-gray-400 dark:text-gray-600">
                      Connect with me
                    </p>
                  </div>
                ...
                <a
                  href="https://github.com/Ritik-kumar045"
                  className="flex items-center gap-4 text-purple-400 hover:text-purple-300"
                >
                  <Github className="w-6 h-6" />
                  <div>
                    <p className="font-semibold dark:text-black">GitHub</p>
                    <p className="text-gray-400 dark:text-gray-600">
                      Check out my code
                    </p>
                  </div>
            ...
            <div className="bg-slate-800/50 dark:bg-gray-200 p-8 rounded-xl backdrop-blur-sm border border-purple-500/20 transition-colors duration-300">
              <div className="space-y-6">
                <div>
                  ...
                  <input
                    type="text"
                    className="w-full px-4 py-3 bg-slate-700/50 dark:bg-gray-100 border border-purple-500/20 rounded-lg focus:outline-none focus:border-purple-500 transition-colors"
                ...
                <div>
                  ...
                  <textarea
                    rows="4"
                    className="w-full px-4 py-3 bg-slate-700/50 dark:bg-gray-100 border border-purple-500/20 rounded-lg focus:outline-none focus:border-purple-500 transition-colors resize-none"
      ...
      <footer className="bg-slate-900/80 dark:bg-white transition-colors duration-300 py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <p className="text-gray-400 dark:text-gray-600">
              © 2025 Ritik Kumar. Built with React & Tailwind CSS.
            </p>
          </div>
        </div>
      </footer>
